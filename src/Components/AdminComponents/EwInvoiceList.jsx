...
const EwInvoiceList = ({createdBy}) => {
  ...
  useEffect(() => {
    if (createdBy) {
      ...
      dispatch(
        fetchInvoiceByStatus({ page, perPage, invoiceType: "ewPolicy", search })
      );
    }
      ...
      {totalCount > 0 ? (
        ...
        <div className="mt-36 font-medium text-body ml-[12%] mr-[15%] mb-20">
          <DataNotFound
            ...
            message="No Ew Policy Invoices found"
          />
        </div>
      )}
    </>
